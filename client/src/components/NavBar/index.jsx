...
import Logo from "../../assets/images/navbar_logo_white.png";
...
function Index() {
  ...
  const [menuActv, setMenuActv] = useState(false);
  ...
  return (
    <div className={style.fs_cont}>
      <div
        className={`${style.menu_cont} ${menuActv ? style.active : ""}`}
        style={{
        ...
        <div className={style.left_side}>
          <a href="/">
            <svg
              ...
              viewBox="1000 900 2000 2000"
            >
              <g
                transform="translate(0.000000,3916.000000) scale(0.100000,-0.100000)"
                fill="#fff"
                stroke="none"
              >
                <path
                  d="M12980 27124 c-19 -2 -84 -9 -145 -15 -634 -63 -1275 -303 -1808
...
6 670 -18z"
        ...
        <div
          ...
          style={{ pointerEvents: menuClick ? "all" : "none" }}
        >
          <span
